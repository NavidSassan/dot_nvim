...
snippets.all = {
  ...
  -- snippet("simple", t "wow, you were right!"),
    ...
    snippet("#!", t("#!/usr/bin/env ")),
    snippet("todo", t("TODO(navid.sassan): ")),
    -- snippet("lfedit", t "Edited by navid.sassan@linuxfabrik.ch on ${=os.date('%Y-%m-%d')}."),

    snippet({ trig = "lfedit" }, {
        t("Edited by navid.sassan@linuxfabrik.ch on "),
        f(function()
